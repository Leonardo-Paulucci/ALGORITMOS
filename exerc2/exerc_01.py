# 1.Escreva um algoritmo que conte quantas operações básicas (somas) são executadas para calcular a soma dos números de 1 até n. Exiba o resultado e compare com a fórmula matemática n*(n+1)/2.
